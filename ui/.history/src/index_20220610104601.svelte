...
<Parallax sections=3 class="bg-conic-to-l from-yellow-500 via-purple-500 to-blue-500" bind:this={parallax}>
    <ParallaxLayer offset=1 rate=1 class="bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r"/>
    <ParallaxLayer offset=2 rate=1 class="bg-gradient-to-b from-gray-900 via-purple-900 to-violet-600"/>

    <ParallaxLayer offset=0 rate=0 span=3
    ...
    <ParallaxLayer offset=1 rate=0.8 style="opacity: 0.1;">
        <!--        -->
        <img src='/meds/medicines-medicine-svgrepo-com.svg' alt=''
             style="display: block; width: 20%; margin-left: 15%;">
    </ParallaxLayer>

    <ParallaxLayer offset=1.75 rate=0.5 style="opacity: 0.2;">
        <img src='/meds/medicine-svgrepo-com (9).svg' alt='' style="display: block; width: 20%; margin-left: 70%;">
        <img src='/meds/medicine-svgrepo-com (6).svg' alt='' style="display: block; width: 20%; margin-left: 40%;">
    </ParallaxLayer>

    <ParallaxLayer offset=1 rate=0.2 style="opacity: 0.3;">
        <img src='/meds/medicine-svgrepo-com (9).svg' alt='' style="display: block; width: 10%; margin-left: 10%;">
        <img src='/meds/medicine-svgrepo-com (6).svg' alt='' style="display: block; width: 20%; margin-left: 75%;">
    </ParallaxLayer>

    <ParallaxLayer offset=1.6 rate=-0.1 style="opacity: 0.4;">
        <img src='/meds/medicine-svgrepo-com (4).svg' alt='' style="display: block; width: 20%; margin-left: 60%;">
    </ParallaxLayer>

    <ParallaxLayer offset=2.1 rate=0.6 style="opacity: 0.3;">
        <img src='/measurements/temperature-svgrepo-com.svg' alt=''
             style="display: block; width: 20%; margin-left: 5%;">
        <img src='/measurements/sphygmomanometer-blood-pressure-gauge-svgrepo-com.svg' alt=''
             style="display: block; width: 15%; margin-left: 75%;">
    </ParallaxLayer>

    <ParallaxLayer offset=2.6 rate=0.4 style="opacity: 0.3;">
        <img src='/measurements/test-tube-svgrepo-com.svg' alt='' style="display: block; width: 20%; margin-left: 5%;">
        <img src='/measurements/test-tube-svgrepo-com (2).svg' alt=''
             style="display: block; width: 15%; margin-left: 75%;">
    </ParallaxLayer>
    ...
    >
        <div class="flex flex-col items-center text-center">
            ...
            <p class="text-white text-2xl tracking-tight font-serif leading-none ">Start tracking your health today</p>
        </div>
    ...
    >
        <div class="flex flex-col items-center  text-center">
            <p class="text-white text-4xl tracking-tight font-serif leading-none mb-10">Keep track of your meds</p>
            <p class="text-white text-2xl tracking-tight font-serif leading-none ">Increadibly easy to setup</p>
        </div>
        ...
        <div on:click={() => parallax.scrollTo(3, {selector: '.clients-main'})}
            ...
            <svg class="bash stroke-fuchsia-400 fill-fuchsia-400" style="width: 70%;"
                ...
                <g id="Health_notification_gadget">
                    ...
                    <path d="M408.636,126.17a37.4121,37.4121,0,1,0,37.4121,37.4121A37.4543,37.4543,0,0,0,408.636,126.17Zm0,62.8242a25.4121,25.4121,0,1,1,25.4121-25.4121A25.4121,25.4121,0,0,1,408.636,188.994Z"/>
                    <path d="M420.7922,157.6908h-6.457v-6.4565a5.5,5.5,0,1,0-11,0v6.4565h-6.456a5.5,5.5,0,0,0,0,11h6.456v6.4566a5.5,5.5,0,1,0,11,0v-6.4566h6.457a5.5,5.5,0,0,0,0-11Z"/>
    ...
    >
        <div class="flex flex-col items-center text-center">
            <p class="text-white text-4xl tracking-tight font-serif leading-none mb-10">Keep measurements to show
                progress</p>
            <p class="text-white text-2xl tracking-tight font-serif leading-none ">Be your own motivation</p>
        </div>
