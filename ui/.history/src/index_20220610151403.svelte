...
<Parallax
	...
	bind:this={parallax}
>
    <ParallaxLayer offset="0" rate="1" class="bg-gradient-to-b from-gray-500 to-gray-600" />
	<ParallaxLayer offset="1" rate="1" class="bg-gradient-to-b from-gray-900 to-gray-600" />
	<ParallaxLayer
		offset="2"
		rate="1"
	...
	>
		<div class="flex flex-col items-center text-center">
			<p class="text-white text-6xl tracking-tight font-serif leading-none mb-10">
				Track My Health
			</p>
			<p class="text-white text-2xl tracking-tight font-serif leading-none ">
	...
	>
		...
		<div class="text-center mt-10">
			<p
				class="pb-3 text-transparent bg-clip-text bg-gradient-to-br from-purple-400 to-pink-600 text-4xl md:text-5xl font-extrabold tracking-tight font-serif leading-none"
			>
				<a href="/signup">Sign Up</a>
			</p>
			<p
				class="ml-2 pb-3 text-transparent bg-clip-text bg-gradient-to-br from-purple-200 to-pink-200 text-2xl md:text-3xl font-extrabold tracking-tight font-serif leading-none"
			>
				Or
			</p>
			<p
				class="ml-2 pb-3 text-transparent bg-clip-text bg-gradient-to-br from-purple-400 to-pink-600 text-4xl md:text-5xl font-extrabold tracking-tight font-serif leading-none"
			>
				<a href="/signin">Sign In</a>
			</p>
		</div>
	...
	>
		<div class="flex flex-col items-center  text-center">
			<p class="text-white text-4xl tracking-tight font-serif leading-none mb-10">
