...
<Parallax
	...
	bind:this={parallax}
>
	<ParallaxLayer offset="0" rate="1" class="bg-gradient-to-b from-purple-700 to-fuchsia-600" />
	<ParallaxLayer offset="1" rate="1" class="bg-gradient-to-b from-purple-700 to-fuchsia-600" />
	<ParallaxLayer
		offset="2"
		rate="1"
	...
	<ParallaxLayer
		offset=".1"
		rate="0.1"
		class="bg-gradient-to-bl from-purple-400 to-pink-600"
		style="display: flex;
	...
	>
		<div class="flex flex-col items-center text-center">
			<p class="mb-10 font-serif text-4xl leading-none tracking-tight text-slate-900">
