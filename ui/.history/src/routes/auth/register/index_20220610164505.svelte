<script lang="ts">
    ...
    import login from '$lib/routes/auth/login/index.svelte';
    import register from '$lib/routes/auth/register/index.svelte';
...
>
    ...
    />
    <input
            class="input-bordered input-accent"
            type="checkbox"
            name="rememberMe"
            bind:value={autoLogin}
            required
    />
