...
>
	...
	<ParallaxLayer offset="1" rate="1" class="bg-gradient-to-b from-cyan-800 to-rose-300" />
	<ParallaxLayer
		offset="2"
		rate="1"
	...
	<ParallaxLayer offset="1" rate="-0.3">
		<img src="/health-symbolorig.svg" alt="" style="width: 25%; margin-left: 10%;opacity=.2;" />
	</ParallaxLayer>
