<script lang="ts">
    ...
    import {userSession, client} from '$shared';
    ...
    const onNameChanged = async e => {
        let name = e.detail;
        result = name ? (await client.get(new Hello({name}))).result : '';
    };
...
<div class="row justify-content-between">
    ...
    <div class="col col-4 mt-4">
        <div class="ms-4">
            <Input bind:value={txtName} placeholder="Your name" on:input={onNameChanged}></Input>
