...
<div class="row">
    <div class="col-5">
        ...
        <form rel="form" on:submit|preventDefault={submit} class="{cls}">
            ...
            <div class="mb-3">
                <Input type="email" className="input input-bordered w-full max-w-xs" name="userName"
                       bind:value={userName} placeholder="Username" responseStatus={responseStatus}/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <CheckBox primaryColor="var(--primary)" id="rememberMe" name="rememberMe" bind:checked={rememberMe}
                          responseStatus={responseStatus}>
                    Remember Me
                </CheckBox>
            </div>
            <div class="mb-3">
                <ButtonSpinner loading={loading} type="submit" class="btn-lg btn-primary">Login</ButtonSpinner>
