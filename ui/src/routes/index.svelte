...
>
    ...
    <ParallaxLayer offset="1.75" rate="0.5" style="opacity: 0.3;">
        <img
                src="/meds/medicine-svgrepo-com (9).svg"
                alt=""
                style="display: block; width: 20%; margin-left: 70%;"
    ...
    <ParallaxLayer offset="1" rate="0.2" style="opacity: 0.0;">
        <img
                src="/meds/medicine-svgrepo-com (9).svg"
                alt=""
    ...
    <ParallaxLayer offset="1.6" rate="-0.1" style="opacity: 0.4;">
        <img
                ...
                alt=""
                style="display: block; width: 20%; margin-left: 60%; margin-top: -20%;"
        />
    </ParallaxLayer>
